<template>
    <div class="multiple-choice-question">
        <div class="question-display">
            <p class="question-text">What is the capital of Norway?</p>
        </div>
...
const alternatives = ['Oslo', 'Paris', 'Stockholm', 'Lisboa'];
const selectedAnswer = ref(null);
const router = useRouter();

const selectAlternative = (n) => {
    selectedAnswer.value = n;
};

const submitAnswer = () => {
    console.log('Submitted alternative:', selectedAnswer.value);
    router.push('/home');
};
