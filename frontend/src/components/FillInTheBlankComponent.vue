  ...
  <div class="fill-in-the-blank-component">
    ...
    <div class="input-field">
      ...
      <input
        ...
        type="text"
        placeholder="Enter the first part of the question"
      >
    </div>
    <div class="options-container">
      <label class="question-label">What is the blank answer?</label>
      <div
    ...
    <div class="input-field">
      ...
      <input
        ...
        type="text"
        placeholder="Enter the second part of the question"
      >
    </div>
...
const saveQuestion = async () => {
  if(!questionPartOne.value || !questionPartTwo.value || !alternatives.value[0] || !alternatives.value[1] || !alternatives.value[2] || selectedOption.value === null) {
  ...
  const fullQuestion = `${questionPartOne.value} ____ ${questionPartTwo.value}`;

  formData.append('questionText', fullQuestion);
  formData.append('tag', 'fill-in-the-blank');
...
.input-field input[type="text"]:nth-child(2) {
    margin-bottom: 10px;
}
